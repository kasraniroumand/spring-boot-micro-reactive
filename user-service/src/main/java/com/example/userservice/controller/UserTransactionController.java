...
public class UserTransactionController {
    ...
    @PostMapping
    public Mono<TransactionResponseDto> getUserById(@RequestBody Mono<TransactionRequestDto> requestDtoMono){
        return requestDtoMono.flatMap(this.service::craeteTransaction);
    }
